...
export default function Deposit({handleReload, authUserId, companyId}){
    ...
    async function handleDeposit() {
        try{
           ...
           await axios.post('http://founders.test/api/storeTransaction', {
    ...
    return(
        <div className="
        w-[100%]  bg-gray-900 dark:bg-stone-100">
         
         <div className="text-xl py-6 font-extrabold dark:text-gray-900 text-yellow-400 px-10 mt-10 md:px-32 
         border-b-4  dark:border-gray-900 border-yellow-50   
         ">
            Mint tokens
            kompani id:{companyId}
        <div>
        ...
        <div className="walletAdr text-xl">
