//0x5FbDB2315678afecb367f032d93F642f64180aa3npm install ethers
...
export default function Deposit({authUserId}){
    ...
    return(
        ...
        w-[100%]  bg-gray-900 dark:bg-stone-100">
         ...
         <div className="text-4xl py-6 font-extrabold px-10 mt-10 md:px-32 
         border-b-4  dark:border-gray-900 border-yellow-50   
         dark:text-gray-900 text-yellow-400">
            Mint tokens
